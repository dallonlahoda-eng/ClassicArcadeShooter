    ...
    return {
        ...
        draw() {
            ...
            if (this.name === 'grunt') {
                ...
                ctx.fillStyle = this.color;
                ctx.beginPath();
                ctx.arc(0, -2, this.width / 3, 0, Math.PI * 2); // head
                ctx.fill();
                ctx.beginPath();
                ctx.ellipse(0, 4, this.width / 2.5, this.height / 3, 0, 0, Math.PI * 2); // body
                ctx.fill();
                // Eyes
                ctx.shadowBlur = 0;
                ...
                // Large menacing alien with wings
                ctx.fillStyle = this.color;
                // Main body
                ctx.beginPath();
                ctx.moveTo(0, -this.height / 2);
                ...
                ctx.lineTo(-this.width / 1.5, this.height / 3);
